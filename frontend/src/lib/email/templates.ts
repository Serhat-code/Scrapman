function enveloppe(titre: string, corps: string, lien: string, libelleBouton: string): string {
  return `
    <div style="font-family: -apple-system, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px 24px;">
      <h1 style="font-size: 18px; color: #08192b; margin-bottom: 16px;">${titre}</h1>
      <p style="font-size: 14px; color: #2f4f72; line-height: 1.6;">${corps}</p>
      <a href="${lien}" style="display: inline-block; margin-top: 16px; padding: 10px 20px; background: #0963c2; color: #ffffff; text-decoration: none; border-radius: 6px; font-size: 14px;">${libelleBouton}</a>
      <p style="font-size: 12px; color: #4a6787; margin-top: 24px;">
...
<body style="margin:0;padding:0;background-color:#eaf1fb;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#eaf1fb;padding:32px 0;">
    <tr>
      <td align="center">
        <table width="520" cellpadding="0" cellspacing="0" role="presentation"
               style="background-color:#ffffff;border-radius:14px;border:1px solid #ccdcf0;overflow:hidden;">
          <tr>
            <td style="background-color:#04529f;padding:28px 40px;">
              <p style="margin:0;font-size:20px;font-weight:700;color:#ffffff;letter-spacing:-0.3px;">Scrapman</p>
              <p style="margin:4px 0 0;font-size:12px;color:#dfebfc;">Prospection B2B locale</p>
            </td>
          </tr>
          <tr>
            <td style="padding:36px 40px 28px;">
              <p style="margin:0 0 12px;font-size:15px;color:#08192b;line-height:1.6;">Bonjour,</p>
              <p style="margin:0 0 24px;font-size:14px;color:#2f4f72;line-height:1.7;">
              ...
              <table cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td style="background-color:#04529f;border-radius:6px;">
                    <a href="${lien}"
              ...
              <p style="margin:24px 0 0;font-size:12px;color:#4a6787;line-height:1.6;">
                Si le bouton ne fonctionne pas, copiez cette URL dans votre navigateur :<br>
                <span style="word-break:break-all;color:#04529f;">${lien}</span>
              </p>
              <p style="margin:12px 0 0;font-size:12px;color:#4a6787;">
                Ce lien expire dans 24 heures. Si vous n'avez pas créé de compte, ignorez cet email.
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding:16px 40px;background-color:#f2f7fd;border-top:1px solid #ccdcf0;">
              <p style="margin:0;font-size:11px;color:#4a6787;line-height:1.5;">
                Scrapman · Atlamaz Studio · Saint-Étienne, France<br>
                <a href="https://scrapman-nine.vercel.app" style="color:#04529f;text-decoration:none;">scrapman-nine.vercel.app</a>
              </p>
            </td>
          </tr>
        </table>
